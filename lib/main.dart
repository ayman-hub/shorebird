...
import 'package:shorebird_code_push/shorebird_code_push.dart' as push;
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Shorebird Code Push patch update',
      theme: ThemeData(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Shorebird Code Push with title'),
      ),
      body: Column(
        children: [
